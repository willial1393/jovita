...
class FillPermissionsForProveedor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProveedor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.proveedor',
            'admin.proveedor.index',
            'admin.proveedor.create',
            'admin.proveedor.show',
            'admin.proveedor.edit',
