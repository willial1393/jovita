                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'codigo'">{{ trans('admin.producto.columns.codigo') }}</th>
                                    <th is='sortable' :column="'nombre'">{{ trans('admin.producto.columns.nombre') }}</th>
                                    <th is='sortable' :column="'unidad'">{{ trans('admin.producto.columns.unidad') }}</th>
                                    <th is='sortable' :column="'precioP'">{{ trans('admin.producto.columns.precioP') }}</th>
                                    <th is='sortable' :column="'estado'">{{ trans('admin.producto.columns.estado') }}</th>
                                    <th is='sortable' :column="'existencia'">{{ trans('admin.producto.columns.existencia') }}</th>
