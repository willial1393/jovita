...
<div class="form-group row align-items-center"
    ...
    <label for="identificacion" class="col-form-label text-md-right"
        ...
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <input type="text" v-model="form.identificacion" v-validate="'required|integer'" @input="validate($event)"
                   class="form-control"
...
<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('insumo_id'), 'has-success': this.fields.insumo_id && this.fields.insumo_id.valid }">
    <label for="insumo_id" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.ofreproveedor.columns.insumo_id') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.insumo_id" v-validate="'required|integer'" @input="validate($event)"
               class="form-control"
               :class="{'form-control-danger': errors.has('insumo_id'), 'form-control-success': this.fields.insumo_id && this.fields.insumo_id.valid}"
               id="insumo_id" name="insumo_id" placeholder="{{ trans('admin.ofreproveedor.columns.insumo_id') }}">
        <div v-if="errors.has('insumo_id')" class="form-control-feedback form-text" v-cloak>@{{
            errors.first('insumo_id') }}
        </div>
    </div>
</div>
...
<div class="form-group row align-items-center"
    ...
    <label for="unidad" class="col-form-label text-md-right"
        ...
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <input type="text" v-model="form.unidad" v-validate="''" @input="validate($event)" class="form-control"
