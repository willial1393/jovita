<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.descuento" v-validate="'integer'" @input="validate($event)"
               class="form-control"
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.estado" v-validate="''" @input="validate($event)" class="form-control"
               ...
               id="estado" name="estado" placeholder="{{ trans('admin.ofreproveedor.columns.estado') }}">
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.precio" v-validate="'integer'" @input="validate($event)" class="form-control"
