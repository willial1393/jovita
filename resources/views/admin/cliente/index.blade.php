                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'documento'">{{ trans('admin.cliente.columns.documento') }}</th>
                                    <th is='sortable' :column="'tipoDocumento'">{{ trans('admin.cliente.columns.tipoDocumento') }}</th>
                                    <th is='sortable' :column="'nombre'">{{ trans('admin.cliente.columns.nombre') }}</th>
                                    <th is='sortable' :column="'telefono'">{{ trans('admin.cliente.columns.telefono') }}</th>
                                    <th is='sortable' :column="'correo'">{{ trans('admin.cliente.columns.correo') }}</th>
