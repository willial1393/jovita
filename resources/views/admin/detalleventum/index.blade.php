...
@section('title', trans('admin.detalleventum.actions.index'))

@section('body')

    <detalleventum-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/detalleventa') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.detalleventum.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/detalleventa/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.detalleventum.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
	                    ...
	                    <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/detalleventa/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.detalleventum.actions.create') }}</a>
	                    </div>
                    </div>
                </div>
            </div>
