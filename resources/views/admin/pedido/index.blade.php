                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="{{ url('admin/pedidos/create') }}" role="button"><i
                                    class="fa fa-plus"></i>&nbsp; {{ trans('admin.pedido.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        ...
                        <table class="table table-hover table-listing">
                            ...
                            <tr>
                                ...
                                <th is='sortable'
                                    :column="'admin_users_id'">{{ trans('admin.pedido.columns.admin_users_id') }}</th>
                                <th is='sortable' :column="'estado'">{{ trans('admin.pedido.columns.estado') }}</th>
                                <th is='sortable' :column="'fecha'">{{ trans('admin.pedido.columns.fecha') }}</th>
                                <th is='sortable'
                                    :column="'numeroPedido'">{{ trans('admin.pedido.columns.numeroPedido') }}</th>
                                <th is='sortable'
                                    :column="'proveedor_id'">{{ trans('admin.pedido.columns.proveedor_id') }}</th>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/pedidos/create') }}"
                               role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.pedido.actions.create') }}
                            </a>
                        </div>
                    </div>
                </div>
